...
class BasicDetectorSettings(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.detector_label = ctk.CTkLabel(self.settings_frame, text="Basic Frontal Face Detector", font=('Roboto', 14, 'bold', 'italic'), text_color='white')
